...
export function useSetDialog() {
  ...
  function open(options: { type: number,set:(row:any)=>void}) {
    ...
    const checkForm = reactive({
      ...
      matcherList:[{label:'等于空',value:'ISNULL'},{label:'不等于空',value:'NOT_NULL'},{label:'等于',value:'EQ'},{label:'不等于',value:'NOT_EQ'},
        {label:'大于',value:'GT'},{label:'大于等于',value:'GE'},{label:'小于',value:'LT'},{label:'小于等于',value:'LE'},{label:'包含',value:'LIKE'},
        {label:'不包含',value:'NOT_LIKE'},{label:'开始于',value:'PREFIX_LIKE'},{label:'结束于',value:'SUFFIX_LIKE'},{label:'介于',value:'BETWEEN'},
