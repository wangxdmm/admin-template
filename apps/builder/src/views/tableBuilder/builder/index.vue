...
import type {QueryConfig, Column} from '@runafe/unified-api-designer'
      ...
      <RsPlainCard content-class="w-400px p-16px!">
        <n-tabs type="line" animated>
          ...
          <n-tab-pane name="query" tab="查询条件">
            ...
            <RnConditions v-model="queryConfig.advancedQueryFields" button-name="添加筛查条件" @update="editScreen"
                          @add="addScreen"/>
          </n-tab-pane>
